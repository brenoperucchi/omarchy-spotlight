...
var FILE_TIER_EXACT = 6
var FILE_TIER_PREFIX = 5
var FILE_TIER_WORD = 4
var FILE_TIER_SUBSTRING = 3
var FILE_TIER_METADATA = 2
...
function nameTier(name, term) {
  ...
  var idx = n.indexOf(t)
  if (idx < 0) {
    var parts = n.split(/[^a-z0-9]+/)
    var acronym = ""
    for (var i = 0; i < parts.length; i++) if (parts[i]) acronym += parts[i].charAt(0)
    return acronym.indexOf(t) >= 0 ? FILE_TIER_METADATA : FILE_TIER_RESIDUAL
  }
...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    FILE_TIER_METADATA: FILE_TIER_METADATA,
